        ...
        <div className="auth-page__ornament-container">
          ...
          <form action="" method="post" className="auth-page-form" onSubmit={handleSubmit} ref={formRef}>
            <div className="auth-page-form__group">
              ...
              <input className="auth-page-form__control-input" type="text" name="first_name" maxLength={50} placeholder="" defaultValue={stateFormData ? stateFormData.get("first_name") : ""} />
            </div>        
            <div className="auth-page-form__group">
              <label className="auth-page-form__label">Фамилия</label>
              <input className="auth-page-form__control-input" type="text" name="last_name" maxLength={50} placeholder="" defaultValue={stateFormData ? stateFormData.get("last_name") : ""} />
            </div>        
            ...
            <div className="auth-page-form__group">
              ...
              <input className="auth-page-form__control-input" type="text" name="user_workplace" maxLength={250} placeholder="" defaultValue={stateFormData ? stateFormData.get("user_workplace") : ""} />
            </div>        

            <div className="auth-page-form__group">
              <label className="auth-page-form__label">Название организации</label>
              <input className="auth-page-form__control-input" type="text" name="user_workplace_desc" maxLength={500} placeholder="" defaultValue={stateFormData ? stateFormData.get("user_workplace_desc") : ""} />
            </div>        

            <div className="auth-page-form__group">
              <label className="auth-page-form__label">Веб-сайт</label>
              <input className="auth-page-form__control-input" type="text" name="user_website" maxLength={500} placeholder="" defaultValue={stateFormData ? stateFormData.get("user_website") : ""} />
            </div>        
            ...
            <div className="auth-page-form__group">
              ...
              <input className="auth-page-form__control-input" type="text" name="user_skype" maxLength={250} placeholder="" defaultValue={stateFormData ? stateFormData.get("user_skype") : ""} />
            </div>        

            <div className="auth-page-form__group">
              <label className="auth-page-form__label">Twitter (имя пользователя без @)</label>
              <input className="auth-page-form__control-input" type="text" name="twitter" maxLength={250} placeholder="" defaultValue={stateFormData ? stateFormData.get("twitter") : ""} />
            </div>        

            <div className="auth-page-form__group">
              <label className="auth-page-form__label">Профиль Facebook (ссылка)</label>
              <input className="auth-page-form__control-input" type="text" name="facebook" maxLength={250} placeholder="" defaultValue={stateFormData ? stateFormData.get("facebook") : ""} />
            </div>        

            <div className="auth-page-form__group">
              <label className="auth-page-form__label">Профиль ВКонтакте (ссылка)</label>
              <input className="auth-page-form__control-input" type="text" name="vk" maxLength={250} placeholder="" defaultValue={stateFormData ? stateFormData.get("vk") : ""} />
            </div>        

            <div className="auth-page-form__group">
              <label className="auth-page-form__label">Профиль Instagram (имя пользователя без @)</label>
              <input className="auth-page-form__control-input" type="text" name="instagram" maxLength={250} placeholder="" defaultValue={stateFormData ? stateFormData.get("instagram") : ""} />
            </div>        

            <div className="auth-page-form__group">
              <button type="submit" className={`auth-page-form__control-submit`} onClick={handleSubmit}>Сохранить</button>
            </div>   
            <div className="auth-page-form__group center">
              <a href="#" className="auth-page-form__control-link-go-back">Вернуться в режим просмотра</a>
            </div>   
          </form>
          }
        </div>
