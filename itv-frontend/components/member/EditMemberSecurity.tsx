        ...
        <div className="auth-page__ornament-container">
          ...
          <form action="" method="post" className="auth-page-form" onSubmit={handleSubmit} ref={formRef}>
            <div className="auth-page-form__group">
              ...
              <input className="auth-page-form__control-input" type="text" name="login" maxLength={50} placeholder="" defaultValue={regFormData ? regFormData.get("first_name") : ""} />
            </div>        
            <div className="auth-page-form__group">
            ...
            <div className="auth-page-form__group">
              ...
              <div className="auth-page-form__control-subtext">Если вы хотите изменить пароль, укажите здесь новое значение. В противном случае оставьте пустым.</div>
            </div>        
            <div className="auth-page-form__group">
