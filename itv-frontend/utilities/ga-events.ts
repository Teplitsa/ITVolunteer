...
function detectPageType(router, pageType = null) {
  if(!pageType){
    ...
    else if(router.pathname.match(/\/(about-paseka|nagrady|about|conditions|sovety-dlya-nko-uspeshnye-zadachi|contacts)\/?$/)) {
      pageType = 'page';
    }
...
export function regEvent(triggerId, router) {
