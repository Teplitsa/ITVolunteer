...
try {
    ...
    $posts_data = [
        [
            'post_title' => "Соглашение перед созданием задачи",
...
<!-- wp:paragraph -->
<p>К сожалению, на платформе не публикуются задачи от коммерческих, религиозных или политических организаций. Почему? (Линк на правила со списком СО НКО.)</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>Прочитайте (ссылка), какие советы дают опытные IT-волонтеры: как правильно поставить задачу, как мотивировать помогать вам, как избежать распространенных ошибок.</p>
<!-- /wp:paragraph -->
",
        ],
    ];
