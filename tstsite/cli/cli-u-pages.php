...
try {
	...
	$update = array(
		...
		'post_content'	=> 'Блокировка - это временная деактивация профиля. Заблокированные пользователи не могут войти в свой аккаунт, и, поэтому, не могут проявлять активность на сайте.
<h3>Причины блокировки пользователей</h3>
Блокировке подвергаются пользователи, нарушающие правила пользования сайтом, например: рассылают спам, проявляют неуважение к другим участикам и т.д.
<h3>Возникли вопросы? Напишите нам:</h3>
[formidable id="contact-us"]',
	);
