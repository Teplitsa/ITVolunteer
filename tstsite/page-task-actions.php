...
<div class="row in-single">
	...
	<div class="col-md-8">
		...
		<div class="form-group">
			<label for="task-descr"><?php _e('Task description', 'tst');?> <small><a href="<?php echo site_url('/sovety-dlya-nko-uspeshnye-zadachi/') ?>" target="_blank">(<?php _e('Create task instructions', 'tst'); ?>)</a></small><br />Ваша задача помогает в борьбе с последствиями коронавируса? Напишите об этом.</label>
